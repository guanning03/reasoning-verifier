...
math500v_train_path=./benchmarks/math500-verification/train.parquet
math500v_test_path=./benchmarks/math500-verification/test.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5-1.5b-instruct_math500-v_grpo' \
