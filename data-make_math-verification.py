...
def main():
    train_json_path = 'evaluations/outputs_MATH_train_test_split_Qwen2.5-Math-1.5B_train_12000_Qwen_MATH_0shot_0.6_3072.json'
    ...
    train_dataset.push_to_hub("guanning/math-verification", split="train", private=False)
    test_dataset.push_to_hub("guanning/math-verification", split="test", private=False)
